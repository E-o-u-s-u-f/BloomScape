      ...
      {isOpen && (
        <div style={{ position: "fixed", inset: 0, zIndex: 50 }}>
            ...
            {chatselect && (
              ...
              >
                ...
                <div style={{ marginTop: "50px" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: "bold", color: "#000" }}>
                    {chatselect}'s Chat
                  </h3>
                  <div
                    style={{
                  ...
                  >
                    <p style={{ color: "#374151" }}>Start chatting with {chatselect}...</p>
                  </div>
                </div>
              </div>
            )}
          ...
          >
            ...
            >
              <h5 style={{ fontSize: "1.5rem", fontWeight: "600", color: "#374151" }}>
                Inbox
              </h5>
              <button
                onClick={() => {
            ...
            <div style={{ padding: "20px", overflowY: "auto", height: "calc(100% - 115px)" }}>
              {inboxChats.map((chat) => (
                <a
                  href="#"
                  key={chat.id}
                  ...
                  style={{
                    ...
                    borderBottom: "2px solid #000",
                    cursor: "pointer",
                    backgroundColor: chatselect === chat.name ? "#6b7280" : "#fff",
                ...
                >
                  ...
                  <div style={{ textAlign: "right" }}>
                    ...
                    {chat.unreadMessages > 0 && (
                      <span style={{ color: "#d32f2f" }}>{chat.unreadMessages}</span>
                    )}
                  </div>
                </a>
              ))}
